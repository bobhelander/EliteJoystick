    ...
    public static class TmThrottleLandedStateHandler
    {
        ...
        public static void Process(States value, Controller controller)
        {
            if (Reactive.ButtonPressed(value, leftThrottleParked))
            {
                ...
                controller.SetJoystickAxis(16 * 1024, (int)vJoy.Wrapper.Axis.HID_USAGE_RZ, vJoyTypes.Throttle);
            ...
            else if (Reactive.ButtonReleased(value, leftThrottleParked))
            {
                ...
                controller.SetJoystickAxis(32 * 1024, (int)vJoy.Wrapper.Axis.HID_USAGE_RZ, vJoyTypes.Throttle);
